...
{
    /// <summary>
    /// Translation Cache Service (formerly called "Flyweight")
    /// This is actually MEMOIZATION/CACHING pattern, not true Gang of Four Flyweight
    /// For true Flyweight, see WordFlyweightFactory
    /// Reuses translation strings to save API calls
    ...
    public class TranslationCacheService
    {
        ...
        public TranslationCacheService(POT_SEM.Services.Dictionary.ApiDictionaryService apiDictionaryService)
        {
